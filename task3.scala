...
// The program below asks the user for the name of a text file,
// reads in some DNA data from that file, passes the data to
// gcContent (defined above), and prints out the return value.
@main def forTask3() =
